...
public class C03_RsaManuellJava11 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Klartext      :" + printByte(plaintextByte[0]) + "  " + printByte(plaintextByte[1]) + "  "
				+ printByte(plaintextByte[2]));
		System.out.println("Verschlüsselt :" + printInteger(ciphertextBig[0]) + " " + printInteger(ciphertextBig[1])
				+ " " + printInteger(ciphertextBig[2]));
		...
		System.out.println("Verschlüsselt :" + printInteger(ciphertextBig[0]) + " " + printInteger(ciphertextBig[1])
				+ " " + printInteger(ciphertextBig[2]));
		System.out.println("Entschlüsselt :" + printInteger(decryptedtextBig[0]) + "  "
				+ printInteger(decryptedtextBig[1]) + "  " + printInteger(decryptedtextBig[2]));
		...
		System.out.println("Klartext      :" + printByte(plaintextByte2[0]) + "  " + printByte(plaintextByte2[1]) + "  "
				+ printByte(plaintextByte2[2]) + "  " + printByte(plaintextByte2[3]));
		System.out.println("Verschlüsselt :" + printInteger(ciphertextBig2[0]) + " " + printInteger(ciphertextBig2[1])
				+ " " + printInteger(ciphertextBig2[2]) + " " + printInteger(ciphertextBig2[3]));
		...
		System.out.println("Verschlüsselt :" + printInteger(ciphertextBig2[0]) + " " + printInteger(ciphertextBig2[1])
				+ " " + printInteger(ciphertextBig2[2]) + " " + printInteger(ciphertextBig2[3]));
		System.out.println(
				"Entschlüsselt :" + printInteger(decryptedtextBig2[0]) + "  " + printInteger(decryptedtextBig2[1])
						+ "  " + printInteger(decryptedtextBig2[2]) + "  " + printInteger(decryptedtextBig2[3]));
		...
		System.out.println("Verschlüsselung des Textes b-a mit dem PublicKey von Alice");
		System.out.println("Klartext      :" + printByte(plaintextByte3[0]) + "  " + printByte(plaintextByte3[1]) + "  "
				+ printByte(plaintextByte3[2]) + "  " + printByte(plaintextByte3[3]));
		System.out.println("Verschlüsselt :" + printInteger(ciphertextBig3[0]) + " " + printInteger(ciphertextBig3[1])
				+ " " + printInteger(ciphertextBig3[2]) + " " + printInteger(ciphertextBig3[3]));
		...
		System.out.println("Verschlüsselt :" + printInteger(ciphertextBig3[0]) + " " + printInteger(ciphertextBig3[1])
				+ " " + printInteger(ciphertextBig3[2]) + " " + printInteger(ciphertextBig3[3]));
		System.out.println(
				"Entschlüsselt:" + printInteger(decryptedtextBig3[0]) + " " + printInteger(decryptedtextBig3[1]) + " "
						+ printInteger(decryptedtextBig3[2]) + " " + printInteger(decryptedtextBig3[3]));
